@echo off
REM Build script for WinRapids Experiment 009: Dual-Path GPU DataFrame (CUDA C++)
...
echo === Building cuda_dataframe.cu ===
nvcc -O2 -arch=sm_120 -o cuda_dataframe.exe cuda_dataframe.cu -lcudart 2>&1
if %errorlevel% neq 0 exit /b %errorlevel%
echo === Build successful: cuda_dataframe.exe ===
