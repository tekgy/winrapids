@echo off
REM Build script for WinRapids Experiment 010: Kernel Fusion Engine
...
echo === Building fused_ops.cu ===
nvcc -O2 -arch=sm_120 -o fused_ops.exe fused_ops.cu -lcudart 2>&1
if %errorlevel% neq 0 exit /b %errorlevel%
echo === Build successful: fused_ops.exe ===
